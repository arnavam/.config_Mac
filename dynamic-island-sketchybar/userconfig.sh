...
P_DYNAMIC_ISLAND_CORNER_RADIUS=1
...
#
P_DYNAMIC_ISLAND_APPSWITCH_MAX_EXPAND_WIDTH=125 # Max size per character of app name
P_DYNAMIC_ISLAND_APPSWITCH_EXPAND_HEIGHT=40
P_DYNAMIC_ISLAND_APPSWITCH_CORNER_RAD=3 # Corner Radius
...
#
P_DYNAMIC_ISLAND_VOLUME_MAX_EXPAND_WIDTH=145 # Max size when expanded
P_DYNAMIC_ISLAND_VOLUME_EXPAND_HEIGHT=40
P_DYNAMIC_ISLAND_VOLUME_CORNER_RAD=3 # Corner Radius
...
#
P_DYNAMIC_ISLAND_BRIGHTNESS_MAX_EXPAND_WIDTH=145 # Max size when expanded
P_DYNAMIC_ISLAND_BRIGHTNESS_EXPAND_HEIGHT=40
P_DYNAMIC_ISLAND_BRIGHTNESS_CORNER_RAD=3 # Corner Radius
...
P_DYNAMIC_ISLAND_MUSIC_INFO_MAX_EXPAND_WIDTH=200 # Max size when expanded#
P_DYNAMIC_ISLAND_MUSIC_INFO_EXPAND_HEIGHT=90
P_DYNAMIC_ISLAND_MUSIC_INFO_CORNER_RAD=5  # Corner Radius

# Music Idle Info
P_DYNAMIC_ISLAND_MUSIC_IDLE_EXPAND_WIDTH=160

# Resume Info
P_DYNAMIC_ISLAND_MUSIC_RESUME_MAX_EXPAND_WIDTH=200
P_DYNAMIC_ISLAND_MUSIC_RESUME_EXPAND_HEIGHT=90
P_DYNAMIC_ISLAND_MUSIC_RESUME_CORNER_RAD=5 # Corner Radius
...
#
P_DYNAMIC_ISLAND_BATTERY_MAX_EXPAND_WIDTH=200 # Max size when expanded
P_DYNAMIC_ISLAND_BATTERY_EXPAND_HEIGHT=40
P_DYNAMIC_ISLAND_BATTERY_CORNER_RAD=3 # Corner Radius
