...
# Notch Size
P_DYNAMIC_ISLAND_DEFAULT_HEIGHT=40
...
#
P_DYNAMIC_ISLAND_VOLUME_MAX_EXPAND_WIDTH=150 # Max size when expanded
P_DYNAMIC_ISLAND_VOLUME_EXPAND_HEIGHT=56
...
P_DYNAMIC_ISLAND_MUSIC_INFO_MAX_EXPAND_WIDTH=130 # Max size when expanded#
P_DYNAMIC_ISLAND_MUSIC_INFO_EXPAND_HEIGHT=65
